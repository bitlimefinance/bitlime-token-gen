...
contract FactBL_ERC20 {
    string[] public features = ["Ownership","Burning","Mintable","Pausable","Snapshot"];
    ...
    function CreateERC20(string memory name, string memory symbol, uint initial_supply, uint8 decimals_amount) public {
        BL_ERC20PauseMintSnapshot newContract_ = new BL_ERC20PauseMintSnapshot(msg.sender, name, symbol, initial_supply, decimals_amount);
